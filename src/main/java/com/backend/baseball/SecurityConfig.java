...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000")); // ✅ 프론트엔드 도메인만 허용
    ...
    public CorsFilter corsFilter() {
        return new CorsFilter(corsConfigurationSource()); // ✅ 불필요한 `getCorsConfiguration()` 호출 제거
    }
}
